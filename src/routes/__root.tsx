...
import { SupportWhatsAppButton } from "@/components/site/SupportWhatsApp";
import { PresenceTracker } from "@/components/site/PresenceTracker";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nippon | سوق أجهزة التعدين المستعملة" },
      {
        name: "description",
        content: "منصة نيبون لبيع وشراء أجهزة تعدين الكريبتو المستعملة بحماية كاملة للمشتري.",
      },
